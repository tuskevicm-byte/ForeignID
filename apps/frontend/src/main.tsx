...
function App(){
  ...
  async function saveUser(e:any){e.preventDefault();setError('');try{await api('/users',{method:'POST',body:JSON.stringify(userForm)});setUserForm({email:'',password:'',firstName:'',lastName:'',role:'OPERATOR'});await loadUsers()}catch(e:any){setError(e.message)}}
