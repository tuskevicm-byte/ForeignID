...
function App(){
  ...
  async function loadSection(){
    ...
    try{
      ...
      else if(active==='Документы'){const [d,v]=await Promise.all([api('/documents?page='+sectionPage+'&pageSize='+sectionPageSize),api('/visas')]);setData({documents:d.data||[],visas:v.data||[],documentsTotal:Number(d.total||0)})}
